...
$${\color{red}Step\ 2}$$ The RPC Server's call back function get request from RabbitMQ. See [RPCServer.cs](https://github.com/daleiyang/LockFreeHashTable/blob/master/RPCServer/RPCServer.cs#L36) (line 36)
